package com.yann.advance.Utils;
...
public class ExDeviceUtil {
    ...
    public final String getIMEI() {
        ...
        try {
            @SuppressLint("MissingPermission") String SIM = getTM().getSimSerialNumber();
    ...
    public final String getPhoneNumber(Context context) {
        ...
        try {
            @SuppressLint("HardwareIds") String phoneNo = getTM().getLine1Number();
    ...
    public boolean isEmulator() {
        try {
            @SuppressLint("HardwareIds") String imei = getTM().getDeviceId();
